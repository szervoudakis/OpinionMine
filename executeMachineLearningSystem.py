...
from evaluationOfModel import  evaluationOfTrainedModel
...
import pandas as pd
import numpy as np
#performs all the tasks of our system such
# 1. train model ,
# 2. incremental train,
# 3. evaluation metrics with RMSE, MSE, MAE measure
...
#take the test set and start the evaluation proccess..
y_pred=evaluationOfTrainedModel('testSet.csv')
y_true=[]
for i in range(0,len(y_pred)):
    y_true.append(1)
#calculate the metrics RMSE, MAE, MSE
